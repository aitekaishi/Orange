<template>
	<view class="supervision">
		<image class="supervision-image" src="http://lc-ndknejad.cn-n1.lcfile.com/b02a38538f05bd38b063/jiandianyanshou.png" mode="widthFix"></image>
		...
		<view class="view-bt">
			...
			<button plain="true" @click="make"><image class="bt-img3" src="http://lc-ndknejad.cn-n1.lcfile.com/858f6eccb3ae3ce01efc/jiandanyanshoubutton.png" /></button>
		</view>
	</view>
</template>
