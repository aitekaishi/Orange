...
var render = function() {
  ...
  return _c(
    "view",
    { staticClass: "order-cotain" },
    [
      _vm._m(0),
      _c("view", { staticClass: "none" }),
      _c("view", { staticClass: "input" }, [
        _c("image", { attrs: { src: "../../static/img/order/icon-city.png" } }),
        _c("input", {
          directives: [
            {
              name: "model",
      ...
      _c("view", { staticClass: "input" }, [
        _c("image", { attrs: { src: "../../static/img/order/icon-name.png" } }),
        _c("input", {
          directives: [
            {
              name: "model",
      ...
      _c("view", { staticClass: "input" }, [
        _c("image", {
          attrs: { src: "../../static/img/order/icon-phone.png" }
        }),
        _c("input", {
          directives: [
            {
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("view", { staticClass: "yy-success" }, [
      _c("image", {
        attrs: {
          src:
...
var _order = _interopRequireDefault(__webpack_require__(/*! ./pages/order/order.vue */ "C:\\Users\\ThinkPad\\Desktop\\Orange\\pages\\order\\order.vue"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
