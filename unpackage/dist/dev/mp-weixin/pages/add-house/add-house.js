...
var render = function() {
  ...
  return _c("view", { staticClass: "order-cotain" }, [
    ...
    _c("view", { staticClass: "input" }, [
      _c("view", { staticClass: "input-title" }, [_vm._v("所在城市")]),
      _c("input", {
        directives: [
          {
            name: "model",
    ...
    _c("view", { staticClass: "none" }),
    _c("view", { staticClass: "input" }, [
      _c("view", { staticClass: "input-title" }, [_vm._v("联系电话")]),
      _c("input", {
        directives: [
          {
            name: "model",
    ...
    _c("view", { staticClass: "none" }),
    _c("view", { staticClass: "input" }, [
      _c("view", { staticClass: "input-title" }, [_vm._v("详细地址")]),
      _c("input", {
        directives: [
          {
            name: "model",
...
var _addHouse = _interopRequireDefault(__webpack_require__(/*! ./pages/add-house/add-house.vue */ "C:\\Users\\ThinkPad\\Desktop\\Orange\\pages\\add-house\\add-house.vue"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
Page((0, _mpvuePageFactory.default)(_addHouse.default));
