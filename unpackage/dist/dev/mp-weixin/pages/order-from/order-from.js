                ...
                _c("view", { staticClass: "five" }, [
                  _c(
                    "view",
                    {
                      ...
                      attrs: { eventid: "d056ef00-0-" + index },
                      on: {
                  ...
                  _c(
                    "view",
                    {
                      ...
                      attrs: { eventid: "d056ef00-1-" + index },
                      on: {
                        click: function($event) {
                          _vm.pay(index)
                        }
                  ...
                  _c(
                    "view",
                    {
                      staticClass: "five-two button",
                      class: { xixibbb: item.status == "已支付" },
                      attrs: { eventid: "d056ef00-2-" + index },
                      on: {
                        click: function($event) {
                          _vm.assess(index)
                        }
...
var _orderFrom = _interopRequireDefault(__webpack_require__(/*! ./pages/order-from/order-from.vue */ "C:\\Users\\ThinkPad\\Desktop\\Orange\\pages\\order-from\\order-from.vue"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
