        ...
        return _c("view", { key: index, staticClass: "myhouse" }, [
          ...
          _c("view", { staticClass: "myhouseb" }, [
            ...
            _c(
              "text",
              {
                attrs: { eventid: "0b65eb6c-1-" + index },
                on: {
          ...
          _c("view", { staticClass: "myhouseb myhousebb" }, [
            ...
            _c(
              "text",
              {
                attrs: { eventid: "0b65eb6c-2-" + index },
                on: {
                  click: function($event) {
                    _vm.yanfang(index)
                  }
          ...
          _c("view", { staticClass: "myhouseb" }, [
            ...
            _c(
              "text",
              {
                attrs: { eventid: "0b65eb6c-3-" + index },
                on: {
                  click: function($event) {
          ...
          _c("view", { staticClass: "myhouseb" }, [
            ...
            _c(
              "text",
              {
                attrs: { eventid: "0b65eb6c-4-" + index },
                on: {
                  click: function($event) {
          ...
          _c(
            "view",
            {
              ...
              attrs: { eventid: "0b65eb6c-5-" + index },
              on: {
                click: function($event) {
                  _vm.submit(index)
                }
...
var _myhouse = _interopRequireDefault(__webpack_require__(/*! ./pages/myhouse/myhouse.vue */ "C:\\Users\\ThinkPad\\Desktop\\Orange\\pages\\myhouse\\myhouse.vue"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
