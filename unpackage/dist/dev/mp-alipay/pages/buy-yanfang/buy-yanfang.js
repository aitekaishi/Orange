(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["pages/buy-yanfang/buy-yanfang"],{
...
//
//
var _default = { data: function data() {return { address: '', xuan1: false, xuan2: false, tatol: '0', disabled: false, area: '', city: '', name: '', phone: '', server: [] };}, methods: { xuan: function xuan(x) {if (x == 1) {if (this.xuan1 == false) {this.xuan1 = true;this.xuan2 = false;} else {this.xuan1 = false;}}if (x == 2) {if (this.xuan2 == false) {this.xuan2 = true;this.xuan1 = false;} else {this.xuan2 = false;}}}, submit: function submit() {if (this.xuan1 == true && this.xuan2 == true) {this.server = [{ 'id': 9, 'name': '毛坯房验房' }, { 'id': 10, 'name': '精装房验房' }];} else if (this.xuan1 == true && this.xuan2 != true) {this.server = [{ 'id': 9, 'name': '毛坯房验房' }];} else
...
var render = function() {
  ...
  return _c("view", { staticClass: "order-cotainb", attrs: { _hid: 0 } }, [
    ...
    _c("view", { staticClass: "none", attrs: { _hid: 28 } }),
    _c(
      "view",
      { staticClass: "bottom", attrs: { _hid: 29 } },
      [
        _c("view", { staticClass: "bottom-one", attrs: { _hid: 30 } }, [
          _c(
            "text",
            { staticClass: "bottom-one-title", attrs: { _hid: 31 } },
            []
          ),
          _c(
            "text",
            { staticClass: "bottom-one-titlea", attrs: { _hid: 33 } },
            [_vm._v("￥" + _vm._s(_vm.tatol), 34)]
          )
        ]),
        _c(
          "button",
...
var _buyYanfang = _interopRequireDefault(__webpack_require__(/*! ./pages/buy-yanfang/buy-yanfang.vue */ "C:\\Users\\ThinkPad\\Desktop\\Orange\\pages\\buy-yanfang\\buy-yanfang.vue"));
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ "./node_modules/@dcloudio/vue-cli-plugin-uni/packages/megalo/dist/megalo.mp.esm.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
_buyYanfang.default.mpType = 'page';
var app = new _vue.default(_buyYanfang.default);
app.$mount();
...
//# sourceMappingURL=../../../.sourcemap/mp-alipay/pages/buy-yanfang/buy-yanfang.js.map