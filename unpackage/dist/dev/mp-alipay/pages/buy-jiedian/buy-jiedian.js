(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["pages/buy-jiedian/buy-jiedian"],{
...
//
//
var _default = { data: function data() {return { address: '', xuan1: false, xuan2: false, xuan3: false, xuan4: false, xuan5: false, tatol: '0', disabled: false, area: '', city: '', name: '', phone: '', server: [] };}, methods: { xuan: function xuan(x) {if (x == 1) {if (this.xuan1 == false) {this.xuan1 = true;} else {this.xuan1 = false;}}if (x == 2) {if (this.xuan2 == false) {this.xuan2 = true;} else {this.xuan2 = false;}}if (x == 3) {if (this.xuan3 == false) {this.xuan3 = true;} else {this.xuan3 = false;}}if (x == 4) {if (this.xuan4 == false) {this.xuan4 = true;} else {this.xuan4 = false;}}if (x == 5) {if (this.xuan5 == false) {this.xuan5 = true;} else {this.xuan5 = false;}}}, submit: function submit() {var a = this.xuan1;var b = this.xuan2;var c = this.xuan3;var d = this.xuan4;var e = this.xuan5; //水电节点,泥工节点,木作节点,油漆节点,竣工节点
      if (Number(a).toString() + Number(b).toString() + Number(c).toString() + Number(d).toString() + Number(e).toString() == '00000') {this.server = []; //水电节点,泥工节点,木作节点,油漆节点,竣工节点
      } else if (Number(a).toString() + Number(b).toString() + Number(c).toString() + Number(d).toString() + Number(e).toString() == '00001') {this.server = [{ 'id': 16, 'name': '竣工节点' }];} else if (Number(a).toString() + Number(b).toString() + Number(c).toString() + Number(d).toString() + Number(e).toString() == '00010') {this.server = [{ 'id': 15, 'name': '油漆节点' }]; //水电节点,泥工节点,木作节点,,竣工节点
      } else if (Number(a).toString() + Number(b).toString() + Number(c).toString() + Number(d).toString() + Number(e).toString() == '00011') {this.server = [{ 'id': 15, 'name': '油漆节点' }, { 'id': 16, 'name': '竣工节点' }]; //水电节点,泥工节点,木作节点,
      } else
...
var render = function() {
  ...
  return _c("view", { staticClass: "order-cotaina", attrs: { _hid: 0 } }, [
    ...
    _c("view", { staticClass: "radio radio-one", attrs: { _hid: 5 } }, [
      ...
      _c(
        ...
        [
          _c(
            "view",
            { staticClass: "radio-name top", attrs: { _hid: 38 } },
            []
          ),
          _c("view", { staticClass: "radio-contain-rl", attrs: { _hid: 40 } }, [
            _c(
              "view",
              { staticClass: "radio-name radio-rl", attrs: { _hid: 41 } },
              []
            ),
            _c("view", { staticClass: "radio-image", attrs: { _hid: 43 } }, [
              _c("image", {
      ...
      _c(
        ...
        [
          _c(
            "view",
            { staticClass: "radio-name top", attrs: { _hid: 47 } },
            []
          ),
          _c("view", { staticClass: "radio-contain-rl", attrs: { _hid: 49 } }, [
            _c(
              "view",
              { staticClass: "radio-name radio-rl", attrs: { _hid: 50 } },
              []
            ),
            _c("view", { staticClass: "radio-image", attrs: { _hid: 52 } }, [
              _c("image", {
    ...
    _c("view", { staticClass: "none", attrs: { _hid: 55 } }),
    _c(
      "view",
      { staticClass: "bottom", attrs: { _hid: 56 } },
      [
        _c("view", { staticClass: "bottom-one", attrs: { _hid: 57 } }, [
          _c(
            "text",
            { staticClass: "bottom-one-title", attrs: { _hid: 58 } },
            []
          ),
          _c(
            "text",
            { staticClass: "bottom-one-titlea", attrs: { _hid: 60 } },
            [_vm._v("￥" + _vm._s(_vm.tatol), 61)]
          )
        ]),
        _c(
          "button",
...
var _buyJiedian = _interopRequireDefault(__webpack_require__(/*! ./pages/buy-jiedian/buy-jiedian.vue */ "C:\\Users\\ThinkPad\\Desktop\\Orange\\pages\\buy-jiedian\\buy-jiedian.vue"));
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ "./node_modules/@dcloudio/vue-cli-plugin-uni/packages/megalo/dist/megalo.mp.esm.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
_buyJiedian.default.mpType = 'page';
var app = new _vue.default(_buyJiedian.default);
app.$mount();
...
//# sourceMappingURL=../../../.sourcemap/mp-alipay/pages/buy-jiedian/buy-jiedian.js.map