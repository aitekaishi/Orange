(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["pages/qianqishenhe/qianqishenhe"],{
...
//
//
var _default = { data: function data() {return { xuan1: false, xuan2: false, xuan3: false, tatol: '0', disabled: false };}, methods: { xuan: function xuan(x) {if (x == 1) {this.xuan2 = false;this.xuan3 = false;if (this.xuan1 == false) {this.xuan1 = true;this.tatol = 299;} else {this.xuan1 = false;this.tatol = 0;}}if (x == 2) {this.xuan1 = false;this.xuan3 = false;if (this.xuan2 == false) {this.xuan2 = true;this.tatol = 299;} else {this.xuan2 = false;this.tatol = 0;}}if (x == 3) {this.xuan2 = false;this.xuan1 = false;if (this.xuan3 == false) {this.xuan3 = true;this.tatol = 299;} else {this.xuan3 = false;this.tatol = 0;}}}, submit: function submit() {var _this = this;uni.showLoading({ title: '提交中' });
...
var render = function() {
  ...
  return _c("view", { staticClass: "order-cotain", attrs: { _hid: 0 } }, [
    ...
    _c("view", { staticClass: "radio radio-one", attrs: { _hid: 5 } }, [
      _c("view", { staticClass: "radio-title", attrs: { _hid: 6 } }, []),
      _c("view", { staticClass: "none", attrs: { _hid: 8 } }),
      _c("view", { staticClass: "none", attrs: { _hid: 9 } }),
      _c(
        "view",
        {
        ...
        [
          _c(
            "view",
            { staticClass: "radio-name topzzz", attrs: { _hid: 11 } },
            []
          ),
      ...
      _c(
        ...
        [
          _c(
            "view",
            { staticClass: "radio-name topzzz", attrs: { _hid: 20 } },
            []
          ),
      ...
      _c(
        ...
        [
          _c(
            "view",
            { staticClass: "radio-name topzzz", attrs: { _hid: 29 } },
            []
          ),
...
var _qianqishenhe = _interopRequireDefault(__webpack_require__(/*! ./pages/qianqishenhe/qianqishenhe.vue */ "C:\\Users\\ThinkPad\\Desktop\\Orange\\pages\\qianqishenhe\\qianqishenhe.vue"));
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ "./node_modules/@dcloudio/vue-cli-plugin-uni/packages/megalo/dist/megalo.mp.esm.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
_qianqishenhe.default.mpType = 'page';
var app = new _vue.default(_qianqishenhe.default);
app.$mount();
...
//# sourceMappingURL=../../../.sourcemap/mp-alipay/pages/qianqishenhe/qianqishenhe.js.map