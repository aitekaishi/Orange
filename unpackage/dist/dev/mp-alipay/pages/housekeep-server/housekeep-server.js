(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["pages/housekeep-server/housekeep-server"],{
...
//
//
var _default = { data: function data() {return {};}, methods: { bindGetUserInfo: function bindGetUserInfo() {var _this = this;uni.getSetting({ success: function success(res) {console.log(res);if (!res.authSetting['scope.userInfo'] || uni.getStorageSync('avatarUrl') == '') {
            uni.navigateTo({
              url: '../index/index' });
...
//
//
var _default = { data: function data() {return { activeIndexa: 1, activeIndexb: 2, activeIndexc: 2, activeIndexd: 2, activeIndexe: 1, activeIndexf: 2, activeIndexg: 2, activeIndexh: 2 };}, methods: { bindGetUserInfo: function bindGetUserInfo() {var _this = this;uni.getSetting({ success: function success(res) {console.log(res);if (!res.authSetting['scope.userInfo'] || uni.getStorageSync('avatarUrl') == '') {uni.navigateTo({ url: '../index/index' });uni.setStorageSync('activeIndex', 2);} else {uni.setStorageSync('index', 4);var queryaaa = new leanCloud.Query('MyHouse');queryaaa.equalTo('user', leanCloud.User.current());queryaaa.find().then(function (res) {if (res.length > 0) {uni.setStorageSync('supervisionHouse', res.reverse());uni.setStorageSync('supervisionName', "购买前期审核服务");uni.navigateTo({ url: '../my-house/my-house' });} else {uni.navigateTo({
                  url: '../no-house/no-house' });
...
//
//
var _default = { data: function data() {return {};}, methods: { bindGetUserInfo: function bindGetUserInfo() {var _this = this;uni.getSetting({ success: function success(res) {console.log(res);if (!res.authSetting['scope.userInfo'] || uni.getStorageSync('avatarUrl') == '') {uni.navigateTo({ url: '../index/index' });uni.setStorageSync('activeIndex', 2);} else {uni.setStorageSync('index', 2);var queryaaa = new leanCloud.Query('MyHouse');queryaaa.equalTo('user', leanCloud.User.current());queryaaa.find().then(function (res) {if (res.length > 0) {
                uni.setStorageSync('supervisionHouse', res.reverse());
...
var _default = { data: function data() {return { tabs: ['全程监理', '验房', '前期审核', '节点验收'], activeIndex: 0, ac: false };}, components: { jiandianmyanshou: _jiandianmyanshou.default, qianqishenhe: _qianqishenhe.default, room: _room.default, supervision: _supervision.default }, onUnload: function onUnload() {uni.setStorageSync('activeIndex', 0); /* uni.reLaunch({
                                                                                                                                                                                                                                                                                                                                                     	url: '../index/index'
                                                                                                                                                                                                                                                                                                                                                     }) */}, onLoad: function onLoad() {uni.setNavigationBarTitle({ title: '管家服务' });uni.setNavigationBarColor({
      frontColor: '#000000',
...
var render = function() {
  ...
  return _c("view", { staticClass: "supervision", attrs: { _hid: 0 } }, [
    _c("image", {
    ...
    _c("view", { staticClass: "bottom-xixi", attrs: { _hid: 2 } }),
    _c(
      "view",
      { staticClass: "view-bt", attrs: { _hid: 3 } },
      [
        _c(
          "button",
          { attrs: { plain: "true", "open-type": "contact", _hid: 4 } },
          [
            _c("image", {
              staticClass: "bt-img1",
              attrs: { src: "../../static/img/index/kefu.png", _hid: 5 }
            })
          ]
        ),
        _c(
          "button",
          {
            attrs: { plain: "true", _hid: 6 },
            on: { click: _vm.bindGetUserInfo }
          },
          [
            _c("image", {
              staticClass: "bt-img2",
              attrs: { src: "../../static/img/index/buy.png", _hid: 7 }
            })
          ]
        ),
        _c(
          "button",
          { attrs: { plain: "true", _hid: 8 }, on: { click: _vm.make } },
          [
            _c("image", {
              staticClass: "bt-img3",
              attrs: {
...
var render = function() {
  ...
  return _c("view", { staticClass: "supervision", attrs: { _hid: 0 } }, [
    ...
    _c("view", { staticClass: "xzadsdss", attrs: { _hid: 3 } }, [
      _c(
        "view",
        {
          attrs: { _hid: 4 },
    ...
    _c("view", { staticClass: "xzadsdss ", attrs: { _hid: 18 } }, [
      _c(
        "view",
        {
          attrs: { _hid: 19 },
    ...
    _c("view", { staticClass: "bottom-xixi", attrs: { _hid: 32 } }),
    _c(
      "view",
      { staticClass: "view-bt", attrs: { _hid: 33 } },
      [
        _c(
          "button",
          { attrs: { plain: "true", "open-type": "contact", _hid: 34 } },
          [
            _c("image", {
              staticClass: "bt-img1",
              attrs: { src: "../../static/img/index/kefu.png", _hid: 35 }
            })
          ]
        ),
        _c(
          "button",
          {
            attrs: { plain: "true", _hid: 36 },
            on: { click: _vm.bindGetUserInfo }
          },
          [
            _c("image", {
              staticClass: "bt-img2",
              attrs: { src: "../../static/img/index/buy.png", _hid: 37 }
            })
          ]
        ),
        _c(
          "button",
          { attrs: { plain: "true", _hid: 38 }, on: { click: _vm.make } },
          [
            _c("image", {
              staticClass: "bt-img3",
              attrs: {
...
var render = function() {
  ...
  return _c(
    "view",
    { staticClass: "supervision", attrs: { _hid: 0 } },
    [
      _c("image", {
        staticClass: "supervision-image",
        attrs: {
      ...
      _c(
        "swiper",
        { attrs: { "indicator-dots": "true", _hid: 3 } },
        [
          _c("swiper-item", { attrs: { _hid: 4 } }, [
            _c("image", {
      ...
      _c("view", { staticClass: "bottom-xixi", attrs: { _hid: 10 } }),
      _c(
        "view",
        { staticClass: "view-bt", attrs: { _hid: 11 } },
        [
          _c(
            "button",
            { attrs: { plain: "true", "open-type": "contact", _hid: 12 } },
            [
              _c("image", {
                staticClass: "bt-img1",
                attrs: { src: "../../static/img/index/kefu.png", _hid: 13 }
              })
            ]
          ),
          _c(
            "button",
            {
              attrs: { plain: "true", _hid: 14 },
              on: { click: _vm.bindGetUserInfo }
            },
            [
              _c("image", {
                staticClass: "bt-img2",
                attrs: { src: "../../static/img/index/buy.png", _hid: 15 }
              })
            ]
          ),
          _c(
            "button",
            { attrs: { plain: "true", _hid: 16 }, on: { click: _vm.make } },
            [
              _c("image", {
                staticClass: "bt-img3",
                attrs: { src: "../../static/img/index/xixix.png", _hid: 17 }
              })
            ]
          )
        ],
      ...
      _c("view", { staticClass: "weui-tab", attrs: { _hid: 2 } }, [
        ...
        _c("view", { staticClass: "weui-tab__panel", attrs: { _hid: 9 } }, [
          _c(
            ...
            [_c("supervision", { attrs: { _hid: 11, _cid: 0 } })],
            1
          ),
          _c(
            "view",
            ...
            [_c("room", { attrs: { _hid: 1014, _cid: 1 } })],
            1
          ),
          _c(
            "view",
            ...
            [_c("qianqishenhe", { attrs: { _hid: 2017, _cid: 2 } })],
            1
          ),
          _c(
            "view",
            {
              staticClass: "weui-tab__content",
              attrs: {
                hidden: _vm.activeIndex != 3,
                _hid: 3019,
                _batrs: "hidden"
              }
            },
            [_c("jiandianmyanshou", { attrs: { _hid: 3020, _cid: 3 } })],
            1
          )
        ])
      ])
...
var _housekeepServer = _interopRequireDefault(__webpack_require__(/*! ./pages/housekeep-server/housekeep-server.vue */ "C:\\Users\\ThinkPad\\Desktop\\Orange\\pages\\housekeep-server\\housekeep-server.vue"));
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ "./node_modules/@dcloudio/vue-cli-plugin-uni/packages/megalo/dist/megalo.mp.esm.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
_housekeepServer.default.mpType = 'page';
var app = new _vue.default(_housekeepServer.default);
app.$mount();
...
//# sourceMappingURL=../../../.sourcemap/mp-alipay/pages/housekeep-server/housekeep-server.js.map